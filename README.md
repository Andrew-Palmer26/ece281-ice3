...
##Documentation:
Worked with C3C Cavan cook to figure out how to move files into the correct spot to get the simulation to run.

![Wave form that satisfies the truh table](ICE3_WaveForm.png)